...
from ska_sdp_piper.app.executable_pipeline import (
    MAIN_ENTRY_POINT,
    ExecutablePipeline,
...
@mock.patch("ska_sdp_piper.app.executable_pipeline.sys")
...
@mock.patch("ska_sdp_piper.app.executable_pipeline.Pipeline")
@mock.patch(
    "ska_sdp_piper.app.executable_pipeline.os.path.exists",
    return_value=True,
)
@mock.patch("ska_sdp_piper.app.executable_pipeline.importlib.util")
...
@mock.patch("ska_sdp_piper.app.executable_pipeline.Path")
@mock.patch("ska_sdp_piper.app.executable_pipeline.os")
@mock.patch("ska_sdp_piper.app.executable_pipeline.Pipeline")
@mock.patch("ska_sdp_piper.app.executable_pipeline.sys")
@mock.patch("builtins.open")
@mock.patch("ska_sdp_piper.app.executable_pipeline.write_yml")
